...
extracting tables from PDF-files. To read-in the data either  [**pdfminer**](https://github.com/FlorianSchwendinger/pdfminer),
[**pdfboxr**](https://gitlab.com/schwe/pdfboxr)
or
[**tesseract**](https://CRAN.R-project.org/package=tesseract)
can be used. However any package which returns the data in a similar format
